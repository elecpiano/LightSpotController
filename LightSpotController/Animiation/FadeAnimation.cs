...
namespace Animation
{
    public class FadeAnimation : AnimationBase
    {
        ...
        public static void Fade(FrameworkElement element, double from, double to, TimeSpan duration, bool autoReverse, Action<FrameworkElement> completed)
        {
            ...
            animation.Animate(element, from, to, duration, autoReverse, completed);
        }

        public void InstanceFade(FrameworkElement element, double from, double to, TimeSpan duration, bool autoReverse, Action<FrameworkElement> completed)
        {
            this.Animate(element, from, to, duration, autoReverse, completed);
        }

        private void Animate(FrameworkElement element, double from, double to, TimeSpan duration, bool autoReverse, Action<FrameworkElement> completed)
        {
            if (element == null)
            {
                return;
